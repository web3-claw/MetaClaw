...
- **[03/16/2026]** **v0.3.2** — Multi-claw support: IronClaw, PicoClaw, ZeroClaw, and CoPaw now supported alongside OpenClaw. Added OpenRouter as a supported LLM platform.
...
claw_type: openclaw        # "openclaw" | "copaw" | "ironclaw" | "none"
